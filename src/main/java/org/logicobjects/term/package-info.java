/**
 * Most classes in this package are a thin version of the richer JPL classes reifying Prolog logic terms
 * DISCLAIMER: In the current implementation methods and most of their comments have been copied from their corresponding JPL class.
